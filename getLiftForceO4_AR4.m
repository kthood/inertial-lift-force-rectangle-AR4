function [forcex,forcey]=getLiftForceO4_AR4(x,y,rsph,U,rho,L)
%% INPUT:
%  Dimensions -2L < x < 2L, -.5L < y < .5L
...
%
%% DEPENDENCIES
%  Need to have HoLeal_channel_aspectratio4_Re1_mesh8_04-28-2017.mat in the Matlab path
...
% otherwise proceed
    ...
    load HoLeal_channel_aspectratio4_Re1_mesh8_04-28-2017.mat
